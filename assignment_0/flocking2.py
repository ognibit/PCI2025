...
(
    ...
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 4, y // 4)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 2, y // 4)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", 3 * x // 4, y // 4)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 4, y // 2)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 2, y // 2)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", 3 * x // 4, y // 2)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 4, 3 * y // 4)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", x // 2, 3 * y // 4)
    .spawn_obstacle("Assignment_0/images/Solid_red_small.png", 3 * x // 4, 3 * y // 4)
    .run()
)
