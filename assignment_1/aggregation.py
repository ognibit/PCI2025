...
parser.add_argument('--frame_limit', type=int, default=50,
                    help='fps limit, 0 uncaps (Fastest) (default: 50)')
parser.add_argument('--radius', type=int, default=30,
                    help='Radius value (default: 30)')
parser.add_argument('--timer_leave', type=int, default=4,
                    help='Timer leave value in ticks (default: 4)')
parser.add_argument('--timer_join', type=int, default=3,
                    help='Timer join value in ticks (default: 3)')
parser.add_argument('--join_n', type=int, default=2,
